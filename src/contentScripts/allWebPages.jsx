...
// TEST CASE : CAlling proxy store methods before proxy store is ready
// await proxyStore.dispatch(addCopiedItem('Copied Text 1111'));
// const latestStateOutsideReady = proxyStore.getState();
// console.log(
// 	`Latest state outside proxy store ready : `,
// 	latestStateOutsideReady
// );
